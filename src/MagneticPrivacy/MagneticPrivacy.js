...
class MagneticPrivacy extends Component {
  render() {
    return (
      <Container>
        <h2>Privacy Policy</h2> <p> Pipe Dream Apps built the Magnetic app as a Free app. This SERVICE is provided by
                    Pipe Dream Apps at no cost and is intended for use as is.
...
accessible at Magnetic unless otherwise defined in this Privacy Policy.
...
export default MagneticPrivacy;